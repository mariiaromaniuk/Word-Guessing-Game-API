...
public class HangmanFrame extends javax.swing.JFrame { // public class JFrame adds support for the JFC/Swing component architecture
     ...
     * The body of this method is always regenerated when the form is opened in the IDE.
     * Special comments placed in the source by the IDE's GUI Builder (// GEN-...).
     * They are required for the form to open correctly.
     */
    ...
    private void initComponents() {
        ...
        startButton.setFont(new java.awt.Font("sansserif", 0, 20)); // NOI18N
        ...
        backButton.setFont(new java.awt.Font("sansserif", 0, 16));
        backButton.setText("Back");
        backButton.setMaximumSize(new java.awt.Dimension(250, 50));
        backButton.setPreferredSize(new java.awt.Dimension(250, 50));
        ...
        guessedLabel.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        ...
        jButton6.setPreferredSize(new java.awt.Dimension(47, 47));
        row1.add(jButton6);
        ...
        jButton7.setPreferredSize(new java.awt.Dimension(47, 47));
        row1.add(jButton7);
        ...
        jButton8.setPreferredSize(new java.awt.Dimension(47, 47));
        row1.add(jButton8);
        ...
        jButton9.setPreferredSize(new java.awt.Dimension(47, 47));
        row1.add(jButton9);

        jButton19.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton19.setText("P");
        jButton19.setEnabled(false);
        jButton19.setFocusable(false);
        jButton19.setPreferredSize(new java.awt.Dimension(47, 47));
        row1.add(jButton19);
        ...
        jButton10.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton10);

        jButton11.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton11.setText("S");
        jButton11.setEnabled(false);
        jButton11.setFocusable(false);
        jButton11.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton11);

        jButton12.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton12.setText("D");
        jButton12.setEnabled(false);
        jButton12.setFocusable(false);
        jButton12.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton12);

        jButton13.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton13.setText("F");
        jButton13.setEnabled(false);
        jButton13.setFocusable(false);
        jButton13.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton13);

        jButton14.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton14.setText("G");
        jButton14.setEnabled(false);
        jButton14.setFocusable(false);
        jButton14.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton14);

        jButton15.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton15.setText("H");
        jButton15.setEnabled(false);
        jButton15.setFocusable(false);
        jButton15.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton15);

        jButton16.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton16.setText("J");
        jButton16.setEnabled(false);
        jButton16.setFocusable(false);
        jButton16.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton16);

        jButton17.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton17.setText("K");
        jButton17.setEnabled(false);
        jButton17.setFocusable(false);
        jButton17.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton17);

        jButton18.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton18.setText("L");
        jButton18.setEnabled(false);
        jButton18.setFocusable(false);
        jButton18.setPreferredSize(new java.awt.Dimension(47, 47));
        row2.add(jButton18);

        keyPanel.add(row2);

        jButton21.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton21.setText("Z");
        jButton21.setEnabled(false);
        jButton21.setFocusable(false);
        jButton21.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton21);

        jButton22.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton22.setText("X");
        jButton22.setEnabled(false);
        jButton22.setFocusable(false);
        jButton22.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton22);

        jButton23.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton23.setText("C");
        jButton23.setEnabled(false);
        jButton23.setFocusable(false);
        jButton23.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton23);

        jButton24.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton24.setText("V");
        jButton24.setEnabled(false);
        jButton24.setFocusable(false);
        jButton24.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton24);

        jButton25.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton25.setText("B");
        jButton25.setEnabled(false);
        jButton25.setFocusable(false);
        jButton25.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton25);

        jButton26.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton26.setText("N");
        jButton26.setEnabled(false);
        jButton26.setFocusable(false);
        jButton26.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton26);

        jButton27.setFont(new java.awt.Font("sansserif", 0, 13)); // NOI18N
        jButton27.setText("M");
        jButton27.setEnabled(false);
        jButton27.setFocusable(false);
        jButton27.setPreferredSize(new java.awt.Dimension(47, 47));
        row3.add(jButton27);
        row3.add(filler1);
    ...
    public static void main(String args[]) {
        ...
        // Overrides method in Runnable (java.lang)
    ...
    private void initStartPanel() {
        ...
        customField.getDocument().addDocumentListener(new DocumentListener() {
            //override DocumentListener interface functions

            //custom word input validation
            @Override
            public void insertUpdate(DocumentEvent de) {
                //if custom word is too long disable start game button
                if (getCustomString().length() > 30) {
                    startButton.setEnabled(false);
                    startButton.setToolTipText("Word is too long");
                }
                //trigger start button when player entered at least one character
                else if (!startButton.isEnabled()
                        && getCustomString().length() > 0) {
                    startButton.setEnabled(true);
                    startButton.setToolTipText("Start a game with a custom word");
                }
            }

            //reset the custom word input field and start the game over
            @Override
            public void removeUpdate(DocumentEvent de) {
                //trigger start button if custom word field is not empty
                if (startButton.isEnabled()
                        && getCustomString().length() == 0) {
                    startButton.setEnabled(false);
                    startButton.setToolTipText("Enter a custom word");
